...
@Component({
  selector: 'app-most-recent-entry-card',
  templateUrl: './most-recent-entry-card.component.html',
  styleUrls: ['./most-recent-entry-card.component.scss'],
})
export class MostRecentEntryCardComponent implements OnChanges {

  @Input() data: Categories | undefined;

  @Input() titleCategory: undefined | string = '';

  @Input() slug: undefined | string = '';
